package io.github.poeticrainbow.goldentweaks.mixin.tweak.old_fence_connections;
...
public abstract class FenceBlockMixin extends CrossCollisionBlock {
    ...
    private BlockState goldentweaks$fences_connect_to_fences(BlockPlaceContext blockPlaceContext, Operation<BlockState> original) {
